...
const levelsOfStudy = [
	...
	"Graduate University (Masters, Professional, PhD)",
...
const c = {
	...
	localUniversitySchoolIDName: "ASU ID (0123456789)",
	localUniversityShortIDMaxLength: 10,
	registration: {
		...
		universityShortIDRegex: new RegExp("^\\d{10}$"),
