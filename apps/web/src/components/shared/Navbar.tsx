...
export default async function Navbar({ className }: NavbarProps) {
	...
	return (
		<div className="z-50 w-screen">
			<div
				className={cn(
					`relative top-0 z-50 h-16 w-screen border-b border-b-border bg-background/95 backdrop-blur-sm ${oswald.variable}`,
					className,
				)}
			>
					...
					<div className="col-span-2 flex items-center justify-start gap-x-5">
						...
						>
							<Image
								...
								height={32}
							/>
							<h2 className="font-oswald text-lg font-bold text-foreground">
								{c.hackathonName}
							</h2>
						</Link>
